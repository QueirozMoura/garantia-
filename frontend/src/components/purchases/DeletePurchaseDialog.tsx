...
export interface DeletePurchaseDialogProps {
  /** Compra que será excluída (usada para identificação na confirmação). */
  purchase: Purchase
...
/**
 * Confirmação visual para excluir uma compra.
 *
 * Nada é enviado ao abrir: só o clique explícito em "Excluir compra" dispara o
 * DELETE. Cancelar, o X, Escape ou clique fora apenas fecham (e são bloqueados
 * durante a exclusão). Mensagem genérica sobre irreversibilidade — não afirma
 * o que acontece com garantia/documentos, pois isso é regra do backend.
 */
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Tem certeza que deseja excluir esta compra? Essa ação não pode ser
                desfeita.
              </p>
            </div>
          </div>
