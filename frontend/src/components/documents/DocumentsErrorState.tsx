...
export interface DocumentsErrorStateProps {
  message?: string
  onRetry: () => void
}

const FALLBACK_MESSAGE = 'Não foi possível carregar seus documentos.'

export function DocumentsErrorState({ message, onRetry }: DocumentsErrorStateProps) {
  return (
