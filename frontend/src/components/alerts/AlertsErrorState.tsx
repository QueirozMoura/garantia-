...
export interface AlertsErrorStateProps {
  message?: string
  onRetry: () => void
}

const FALLBACK_MESSAGE = 'Não foi possível carregar seus alertas.'

export function AlertsErrorState({ message, onRetry }: AlertsErrorStateProps) {
  return (
